...
var hljs = (function () {
    ...
    */
    ...
    @typedef {import('highlight/highlight.js/private').MatchType} MatchType
    @typedef {import('highlight/highlight.js/private').KeywordData} KeywordData
    @typedef {import('highlight/highlight.js/private').EnhancedMatch} EnhancedMatch
    @typedef {import('highlight/highlight.js/private').AnnotatedError} AnnotatedError
